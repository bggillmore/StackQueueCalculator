...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { stackQueueLed }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { stackQueue }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
#set_property MARK_DEBUG true [get_nets sseg/rst]
